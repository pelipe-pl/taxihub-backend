...
public class ErrorCodes {
    ...
    final static String ERROR_400_BAD_REQUEST = "Bad Request. The request could not be understood by the server due to malformed syntax. " +
    ...
    final static String ERROR_405_METHOD_NOT_ALLOWED = "";
