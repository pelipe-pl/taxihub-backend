...
public class ErrorCodes {
    ...
    final static String ERROR_500_INTERNAL_SERVER_ERROR = "The server encountered an internal error or misconfiguration and was unable to complete your request.";
